                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                    ...
                    <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                      ...
                      <div
                        ...
                        <p style="text-align: center;"><span
                            style="font-size: 24px;"><strong>${ong.name}</strong></span></p>
                        <p style="text-align: center;">&nbsp;</p>
                        <p style="text-align: center;"><span style="font-size: 16px;">${ong.welcomeText}</span></p>
                      </div>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                      ...
                      <div
                        style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
                        <p style="text-align: center;">${ong.address}</p>
                        <p style="text-align: center;">${ong.email}</p>
                        <p style="text-align: center;">${ong.phone}</p>
                      </div>
